...
const productSchema = sequelize.define("Product",{
    ...
    productTag: {
        ...
        set(val) {
        this.setDataValue("productTag", Array.isArray(val) ? val.join(",") : val || '');
        },
    },
    ...
    dimension: {
        ...
        get() {
            ...
            return value && typeof value === "string" ? JSON.parse(value) : value || { length: 0, width: 0, height: 0 };
        },
        set(value) {
            this.setDataValue("dimension", typeof value === "object" ? value : { length: 0, width: 0, height: 0 });
        },
    },
